...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "39855240"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","a17c43755159b1e8fc0ea5120d00675f")
# ------------------------------------------------
...
# -----------------------------------------------
join = '<a href="https://t.me/BR0DG">✳️ JOIN BACKUP</a>'
# -----------------------------------------------
UNSPLASH_ACCESS_KEY = 'RabDRmuXXBobanmwwbvpP5LwoG4J8ox34y5Sstz-9jk'
# -----------------------------------------------
UNSPLASH_QUERY = 'animal baby'
# -----------------------------------------------
ADMIN_BOT_USERNAME = "https://t.me/Dheeraj_1337" #without @
